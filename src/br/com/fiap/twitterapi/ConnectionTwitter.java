...
public class ConnectionTwitter {
	...
	public ConnectionTwitter() {
		...
		String value = config.getProp().getProperty("consumer");
		String consumer_key = config.getProp().getProperty("consumer_key");
		twitter.setOAuthConsumer(value, consumer_key);
		twitter.setOAuthAccessToken(accessToken);

	}
	
	public List<Tweet> buscarHashTag(String search) throws TwitterException {
	...
	public static void main(String[] args) {
		...
		try {			
			...
			ConnectionTwitter conn = new ConnectionTwitter();
			List<Tweet> listTweet = conn.buscarHashTag("#java");
